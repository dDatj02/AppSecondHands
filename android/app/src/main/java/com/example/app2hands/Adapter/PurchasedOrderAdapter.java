...
public class PurchasedOrderAdapter extends RecyclerView.Adapter<PurchasedOrderAdapter.ViewHolder> {
    ...
    public PurchasedOrderAdapter(ArrayList<Product> listProduct, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View purchaseView = LayoutInflater.from(context).inflate(R.layout.purchased_item, parent, false);
